<footer class="bg-dark-900 text-dark-300 py-12 px-4 sm:px-6 md:py-16 lg:px-8">
    <div class="mx-auto grid gap-8 sm:max-w-3xl md:grid-cols-3 md:gap-y-12 lg:max-w-screen-xl lg:grid-cols-4">

        <!-- Logo and copyright text -->
        <div class="flex flex-col lg:mx-auto">
            <div class="flex items-center">
                <a href="{{ $page->baseUrl }}/" class="group text-2xl font-black text-white lg:block">
                    <svg xmlns="http://www.w3.org/2000/svg" height="44" viewBox="0 0 107.46 20.67" fill="currentColor">
                        <g>
                            ...
                            <path d="M34.43,10.82v1.81H31.65v8H29.37v-8H26.6V10.82Z" />
            ...
            <div class="mt-6 text-sm md:mt-8">
                &#169; {{ date('Y') }} Urban Timetravel S.A.
        ...
        <div class="lg:mx-auto">
            ...
            <ul class="mt-2 space-y-1 text-md">
                <li class="text-green over:text-white underline">
                    <a href="{{ $page->baseUrl}}/imprint">
                        Impressum
                    </a>
                </li>
                <li class="text-green over:text-white underline">
                    <a href="{{ $page->baseUrl}}/privacy">
    ...
    <div class="text-white pt-12">
        <svg class="mx-auto" width="88" viewBox="0 0 511.97 410.08" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
            <defs>
                <clipPath id="b">
            ...
            <path d="m112.08 282.31 17.262 39.883 17.328-39.883 9.6367 50.215h-5.418l-6.1094-32.133h-0.12891l-15.309 34.086-15.246-34.086h-0.125l-6.1133 32.133h-5.418l9.6406-50.215" />
            <path d="m187.3 295.11-8.1289 19.023h16.066zm-10.27 23.938-5.7344 13.484h-5.7969l21.926-49.773 21.359 49.773h-5.8594l-5.6094-13.484h-20.285" />
            <path d="m230.64 327.61c5.7969 0 10.648-0.82031 14.996-4.9141 3.9062-3.6562 5.9219-8.6328 5.9219-13.926 0-5.418-2.0781-10.645-6.1719-14.238-4.3477-3.8438-9.1367-4.5977-14.746-4.5977h-3.8398v37.676zm-9.1328-42.59h8.9453c7.1211 0 12.914 0.94531 18.523 5.7344 5.418 4.6602 7.875 11.023 7.875 18.082 0 6.9297-2.5195 13.039-7.75 17.703-5.668 5.0391-11.34 5.9844-18.773 5.9844h-8.8203v-47.504" />
            <path d="m271.79 285.02h24.633v4.9141h-19.34v14.113h18.773v4.9141h-18.773v18.648h19.34v4.9141h-24.633v-47.504" />
            <path d="m345.37 332.53h-5.293v-47.504h5.293v47.504" />
            <path d="m362.88 283.01 37.047 38.809v-36.793h5.2891v49.645l-37.043-38.746v36.605h-5.293v-49.52" />
            <path d="m26.055 403.21h13.105v4.9102h-18.398v-47.504h5.293v42.594" />
            <path d="m57.113 388.91c0 3.5273-0.125 7.5625 2.082 10.586 2.0781 2.8984 6.1094 4.5352 9.5742 4.5352 3.4023 0 7.1211-1.5742 9.3242-4.2188 2.5195-3.0273 2.332-7.1836 2.332-10.902v-28.289h5.293v29.738c0 5.168-0.37891 9.2617-4.1602 13.168-3.2773 3.5273-8 5.418-12.789 5.418-4.4727 0-9.0703-1.6992-12.285-4.8516-4.1562-3.9688-4.6641-8.3164-4.6641-13.734v-29.738h5.293v28.289" />
            <path d="m99.891 360.62h6.0469l9.7031 17.895 9.7031-17.895h6.0508l-12.855 22.934 14.051 24.57h-6.0508l-10.898-19.527-10.898 19.527h-6.0469l14.047-24.57-12.852-22.934" />
            <path d="m145.75 360.62h24.637v4.9141h-19.344v14.113h18.773v4.9141h-18.773v18.652h19.344v4.9102h-24.637v-47.504" />
            <g clip-path="url(#b)">
                <path d="m193.13 357.91 17.266 39.879 17.324-39.879 9.6406 50.211h-5.418l-6.1133-32.129h-0.125l-15.309 34.082-15.25-34.082h-0.125l-6.1094 32.129h-5.418l9.6367-50.211" />
            </g>
            <path d="m256.26 403.21h5.2891c5.9258 0 12.16-1.4492 12.16-8.6953 0-7.375-7.0547-8.4453-12.852-8.4453h-4.5977zm0-21.676h2.0156c5.9844 0 11.086-0.69141 11.086-8.0625 0-7.1836-4.5352-7.9414-11.023-7.9414h-2.0781zm-5.293-20.918h7.8125c8.6289 0 15.875 3.1523 15.875 12.855 0 3.8398-1.4492 7.1172-4.6602 9.2578 5.668 1.3867 9.0078 6.4922 9.0078 12.16 0 9.4531-7.6211 13.23-17.012 13.23h-11.023v-47.504" />
            <path d="m297.21 384.38c0 10.711 8.6953 19.656 19.469 19.656 10.773 0 19.469-8.9453 19.469-19.656 0-10.773-8.5703-19.656-19.469-19.656-10.902 0-19.469 8.8828-19.469 19.656zm44.227 0.0625c0 13.672-11.215 24.508-24.758 24.508-13.547 0-24.762-10.836-24.762-24.508 0-13.609 11.215-24.633 24.762-24.633 13.543 0 24.758 11.023 24.758 24.633" />
            <path d="m361.34 388.91c0 3.5273-0.125 7.5625 2.0781 10.586 2.0781 2.8984 6.1133 4.5352 9.5781 4.5352 3.4023 0 7.1172-1.5742 9.3242-4.2188 2.5195-3.0273 2.332-7.1836 2.332-10.902v-28.289h5.293v29.738c0 5.168-0.37891 9.2617-4.1602 13.168-3.2773 3.5273-8 5.418-12.789 5.418-4.4727 0-9.0742-1.6992-12.285-4.8516-4.1602-3.9688-4.6641-8.3164-4.6641-13.734v-29.738h5.293v28.289" />
            <path d="m412.18 382.61h1.6406c5.9844 0 12.031-1.1328 12.031-8.5039 0-7.8125-5.7305-8.5703-12.094-8.5703h-1.5781zm0 25.516h-5.2891v-47.504h6.8672c9.0078 0 17.387 2.3945 17.387 13.105 0 7.3086-4.5977 12.477-11.906 13.105l15.121 21.293h-6.4883l-14.367-20.852h-1.3242v20.852" />
            <path d="m492.76 384.25c0.125 6.4258-0.57031 11.719-4.918 16.758-4.3438 5.0391-10.961 7.9375-17.574 7.9375-13.359 0-24.449-11.09-24.449-24.445 0-13.609 11.09-24.695 24.762-24.695 8.3164 0 15.059 3.7148 20.098 10.27l-3.8438 3.5898c-3.9688-5.6055-9.3242-8.9453-16.316-8.9453-10.836 0-19.406 9.1328-19.406 19.844 0 5.043 2.0156 9.832 5.5469 13.422 3.4648 3.4648 8.5039 6.0469 13.48 6.0469 8.2539 0 16.949-6.0469 16.949-14.867h-14.113v-4.9141h19.785" />
            <path transform="matrix(.1 0 0 -.1 0 410.08)" d="m1284 2926.3c-112.42 54.141-238.4 84.453-371.52 84.453-473.59 0-857.5-383.91-857.5-857.5 0-39.961 2.7344-79.297 8.0078-117.81 0 0 8.3984-78.711 113.59-420.31l161.84-601.64 46.562-172.73m899.02 2085.5c1.25-0.58594 2.4219-1.25 3.6719-1.8359 153.2 225.51 411.02 374.18 703.75 376.21h7.3438c215.2-1.5234 411.45-82.461 561.21-214.84m-937.81-1413.7c93.203 137.19 147.77 302.77 147.77 481.13 0 339.02-196.76 632.03-482.27 771.21-93.203-137.23-147.73-302.85-147.73-481.21 0-338.98 196.76-631.95 482.23-771.13z" fill="none" stroke="currentColor" stroke-width="110" />
            <g clip-path="url(#a)">
                <path transform="matrix(.1 0 0 -.1 0 410.08)" d="m4734.7 840.8 46.562 172.73 161.84 601.64c105.2 341.6 113.59 420.31 113.59 420.31 5.2734 38.516 8.0078 77.852 8.0078 117.81 0 473.59-383.91 857.5-857.5 857.5-133.09 0-259.1-30.312-371.52-84.453m-1276 159.53c149.77 132.38 346.02 213.32 561.25 214.84h7.3438c292.7-2.0312 550.51-150.7 703.71-376.21 1.25 0.58594 2.4609 1.25 3.6719 1.8359m144.06-483.05c0 178.36-54.492 343.98-147.7 481.21-285.55-139.18-482.3-432.19-482.3-771.21 0-178.36 54.57-343.95 147.77-481.13 285.47 139.18 482.23 432.15 482.23 771.13z" fill="none" stroke="currentColor" stroke-width="110" />
            </g>
            <path transform="matrix(.1 0 0 -.1 0 410.08)" d="m2845 3760.8c0-157.38-127.62-285-285-285-157.38 0-285 127.62-285 285 0 157.38 127.62 285 285 285 157.38 0 285-127.62 285-285z" fill="none" stroke="currentColor" stroke-width="110" />
            <path transform="matrix(.1 0 0 -.1 0 410.08)" d="m2560 3085.9c-177.77-157.11-290-386.68-290-642.58 0-255.9 112.23-485.47 290-642.58 177.77 157.11 290 386.68 290 642.58 0 255.9-112.23 485.47-290 642.58" fill="none" stroke="currentColor" stroke-width="110" />
        </svg>
    </div>
</footer>