<footer class='py-12 px-4 md:py-16 bg-dark-900 text-green sm:px-6 lg:px-8'>
  <div class='grid gap-8 mx-auto lg:max-w-screen-xl sm:max-w-3xl md:grid-cols-3 md:gap-y-12 lg:grid-cols-4'>
    ...
    <div class='flex flex-col lg:mx-auto'>
      <div class='flex items-center'>
        <a href="index.html" class='text-2xl font-black text-white lg:block group'>
      ...
      <div class='mt-6 text-lg md:mt-8'>
        &#169; {{ date('Y') }} Urban Timetravel.
    ...
    <div class='lg:mx-auto'>
      ...
      <ul class='mt-2 space-y-1 text-lg'>
        <li class='font-medium hover:text-white'>
          <a href='index.html'>
            Start
          </a>
        </li>
