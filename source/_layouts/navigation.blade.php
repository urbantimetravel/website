<nav class='flex items-center px-4 pt-6 mx-auto max-w-7xl sm:px-6 lg:px-8'>
  <div class='flex justify-between items-center w-full'>
    ...
    <div class='flex items-center'>
      <a href="index.html" class='block text-2xl font-black text-white'>
      <svg xmlns="http://www.w3.org/2000/svg" height="36" viewBox="0 0 107.46 20.67" fill="currentColor">
          <g>
    ...
    <!--<div class='hidden md:flex justify-between items-center md:space-x-0.5 lg:space-x-2 text-xl md:text-base font-medium text-green-300'>
      <a href="#home" class="block py-1 px-4 rounded-full transition duration-200 ease-in-out sm:inline-block hover:text-white hover:bg-dark-700">
        Start
      </a>
      <a href="#projects" class="block py-1 px-4 rounded-full transition duration-200 ease-in-out sm:inline-block hover:text-white hover:bg-dark-700">
        Projekte
      </a>
      ...
      <a href="#cta" class="block py-1 px-4 rounded-full transition duration-200 ease-in-out sm:inline-block hover:text-white hover:bg-dark-700">
        Kontakt
      </a>
    </div>-->

    <div class='hidden md:block'>
      <a class="flex justify-center items-center py-3 px-8 w-auto text-base font-semibold leading-snug bg-white rounded-full transition ease-in-out duration-250 text-green-900 hover:text-white focus:outline-none hover:bg-green" href="contact.html">
        Kontakt aufnehmen
      </a>
    </div>
    ...
    <div class='block md:hidden' x-data="{ open: false }">
      ...
      <div class='hidden absolute top-0 left-0 z-40 justify-center items-center w-screen h-screen bg-gradient-to-tr from-dark-800 to-dark-900' :class="{ 'js-mobileNav-open': open }" @keydown.escape.window="open = false">
        <div class='flex flex-col justify-evenly items-center p-4 mx-auto space-y-8 w-full text-xl'>
          <a href="index.html" class="block py-2 px-6 font-medium rounded-full transition duration-200 ease-in-out text-green-300 hover:text-white hover:bg-dark-700 sm:inline-block">
            Home
          </a>
          <a href="services.html" class="block py-2 px-6 font-medium rounded-full transition duration-200 ease-in-out text-green-300 hover:text-white hover:bg-dark-700 sm:inline-block">
            Services
          </a>
          <a href="about.html" class="block py-2 px-6 font-medium rounded-full transition duration-200 ease-in-out text-green-300 hover:text-white hover:bg-dark-700 sm:inline-block">
            About
          </a>
          <a href="work.html" class="block py-2 px-6 font-medium rounded-full transition duration-200 ease-in-out text-green-300 hover:text-white hover:bg-dark-700 sm:inline-block">
            Work
          </a>
          <a href="case-study.html" class="block py-2 px-6 font-medium rounded-full transition duration-200 ease-in-out text-green-300 hover:text-white hover:bg-dark-700 sm:inline-block">
            Case study
          </a>

          <a class="flex justify-center items-center py-4 px-8 w-auto text-lg font-semibold leading-snug bg-white rounded-full transition ease-in-out duration-250 text-green-900 hover:text-white focus:outline-none hover:bg-dark-700" href="contact.html">
            Let's talk
          </a>
        </div>
      </div>
