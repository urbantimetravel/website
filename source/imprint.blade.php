    ...
    <div class="mx-auto w-6/12">
      ...
      <div>
        ...
        <p class="text-dark-300 mt-1 text-sm text-base">
          ...
          <span>
            <svg class="inline h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
      ...
      <div class="text-green">
        ...
        <p class="text-dark-300 mt-1 text-sm text-base">
          Grundsätzlich unterlegen alle von uns erstellten Informationen dem Urheberrecht. Sollten Sie Inhalte
          weitergeben, bearbeiten oder vervielfältigen wollen, senden Sie uns bitte vorher eine Anfrage.
          Inhalte bzw. Werke von Dritten kennzeichnen wir entsprechend.
        </p>
        <h5 class="mt-3 text-lg font-bold text-white">
          Quellennachweis
        </h5>
        <ul class="mt-2 space-y-1 text-sm">
          <li class="font-medium hover:text-white"><a href="https://jigsaw.tighten.com">Website Jigsaw Static
              Sitegenerator<span>
                <svg class="inline h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                  <path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" />
                  <polyline points="15 3 21 3 21 9" />
          ...
          <li class="font-medium hover:text-white"><a href="https://www.thenounproject.com">Icons The Noun
              Project<span>
                <svg class="inline h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                  <path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" />
                  <polyline points="15 3 21 3 21 9" />
